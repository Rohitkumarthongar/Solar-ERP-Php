            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" required placeholder="e.g. PM Surya Ghar Muft Bijli Yojana"
                    ...
                    <div>
                        ...
                        <textarea name="short_description" rows="3" placeholder="Brief summary of the blog post..."
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-300">{{ old('short_description') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="12" required placeholder="Write the full content here..."
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm font-mono bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-300">{{ old('content') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="url" name="overview_url" value="{{ old('overview_url') }}"
                            placeholder="https://example.com/full-overview"
                            class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-300">
                        <p class="text-[10px] text-gray-400 mt-1">Optional external link for users who want the full resource or official overview.</p>
                ...
                <div class="space-y-6 border-t lg:border-t-0 lg:border-l border-gray-100 lg:pl-8 pt-6 lg:pt-0">
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400">Recommended: 1200x630. JPG, PNG</p>
                        @error('image') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                    </div>

                    <div class="flex items-center gap-3">
                        <label class="flex items-center cursor-pointer gap-2">
                            <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 text-orange-500 rounded border-gray-200 focus:ring-orange-500">
